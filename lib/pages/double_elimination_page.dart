...
class DoubleEliminationPage extends StatelessWidget {
  ...
  DoubleEliminationPage({required this.routeName, super.key});
      ...
      body: provider.players.isEmpty
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              _buildBracketSection(provider, "Winners Bracket", provider.playerList, provider.onTap),
              _buildBracketSection(provider, "Losers Bracket", provider.losersPlayerList, provider.onLoserTap),
            ],
          ),
        ),
      ),
